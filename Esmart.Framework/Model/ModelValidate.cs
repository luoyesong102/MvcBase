...
{
    public delegate bool Validator<TEntity>(TEntity entity, out string message) ;
    public delegate bool ValidMethod();

    /// <summary>
    /// 验证工具类EntityModelValidate.Validate(ModelValidate.AddUpdateValidate, entity);   model.PayOrderNo.HasValue("退款流水号不能为空", tempMessage).GoOn(() => model.PayOrderNo.MaxLength(200, "退款流水号", tempMessage));
    /// </summary>
